...
extern void beep_set();
extern void test_fun(void(*ledset)(u8),u8 sta);
extern void * test1(void);
//函数名列表初始化(用户自己添加)
//用户直接在这里输入要执行的函数名及其查找串
struct _m_usmart_nametab usmart_nametab[]=			// 这个是结构体数数组，每个结构体中包含的是 一个函数指针和，一个字符串；
{
#if USMART_USE_WRFUNS==1 	//如果使能了读写操作
	{(u32*)read_addr,(char *)("u32 read_addr(u32 addr)")},
	{(u32*)write_addr,(char *)"void write_addr(u32 addr,u32 val)"},	     
#endif
	{(u32*)delay_ms,(char *)"void delay_ms(u16 nms)"},
	{(u32*)delay_us,(char *)"void delay_us(u32 nus)"},	 
	{(u32*)led_set,(char *)"void led_set(u8 sta)"},
	{(u32*)beep_set,(char *)"void beep_set()"},
